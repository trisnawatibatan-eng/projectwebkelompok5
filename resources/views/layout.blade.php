...
        
        /* ========================================= */
        /* --- KOREKSI CSS BARU UNTUK SUB-MENU POLIKLINIK --- */
        /* ========================================= */
        
        /* Style untuk UL yang berada di dalam Collapse (nav-treeview) */
        .nav-treeview {
            padding-left: 0; 
            list-style: none;
            margin-bottom: 0;
        ...
        /* Style untuk link di sub-menu */
        .nav-treeview .nav-item .nav-link {
            /* Mengurangi padding horizontal untuk sub-link dan menambahkan indentasi */
        ...
        /* Menghilangkan ikon di sub-menu */
        .nav-treeview .nav-link i {
            display: none; 
        }

        /* Style untuk ikon panah berputar di menu induk */
        .sidebar .nav-link.justify-content-between .bi-chevron-down {
            transition: transform 0.3s ease;
        }

        /* Saat menu terbuka (collapse: show), ikon panah berputar */
...
>>>>>>> f868db48cec9d34adf8065fb4d9df4824cbf45e4
                ...
                <a href="#poliSubmenu" 
                    class="nav-link d-flex align-items-center justify-content-between {{ request()->routeIs('poliklinik.*') ? 'active' : '' }} {{ request()->routeIs('poliklinik.*') ? '' : 'collapsed' }}" 
                    data-bs-toggle="collapse" 
                    data-bs-target="#poliSubmenu" 
                    aria-expanded="{{ request()->routeIs('poliklinik.*') ? 'true' : 'false' }}">
                    
                    <div class="d-flex align-items-center">
                        <i class="bi bi-hospital-fill"></i>
                        <span class="ms-3">Poliklinik</span>
                    </div>
                    {{-- Ikon panah (bi-chevron-down) akan berputar menggunakan CSS di atas --}}
                    <i class="bi bi-chevron-down ms-auto" style="font-size: 0.8rem;"></i>
                </a>
                
                {{-- SUB-MENU POLIKLINIK (Target Dropdown) --}}
                {{-- Gunakan class 'show' agar tetap terbuka jika berada di salah satu sub-route poliklinik --}}
                <div class="collapse {{ request()->routeIs('poliklinik.*') ? 'show' : '' }}" id="poliSubmenu">
                    <ul class="nav nav-treeview flex-column"> 
                        <li class="nav-item">
                            <a href="{{ route('poliklinik.umum') }}" class="nav-link {{ request()->routeIs('poliklinik.umum') ? 'active' : '' }}">
                                Poli Umum
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('poliklinik.gigi') }}" class="nav-link {{ request()->routeIs('poliklinik.gigi') ? 'active' : '' }}">
                                Poli Gigi
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('poliklinik.kia') }}" class="nav-link {{ request()->routeIs('poliklinik.kia') ? 'active' : '' }}">
                                KIA
                            </a>
                        </li>
                    </ul>
